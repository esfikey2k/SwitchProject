...
import com.example.switchproject.databinding.FragmentGivingBinding
...
class GivingFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        try {
            ...
            val animator = ObjectAnimator.ofFloat(binding.cardviewRengoku, "translationX", 0f, -350f)
            ...
            animatorSet.addListener(object : AnimatorListenerAdapter() {
                override fun onAnimationEnd(animation: Animator) {
                    ...
                    activity?.let {
                        ...
                        displayTextWordByWord(100,binding.textViewName, it.getString(R.string.name_of_rengoku_txt)) {
                            Handler(Looper.getMainLooper()).postDelayed({
                                displayTextWordByWord(30,binding.textViewStoryLong, it.getString(R.string.rengoku_story_txt))
                            }, 250)
                        }
                    }
