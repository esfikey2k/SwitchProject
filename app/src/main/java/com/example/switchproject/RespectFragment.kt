...
import com.example.switchproject.databinding.FragmentRespectBinding
...
class RespectFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        try {
            ...
            val animator = ObjectAnimator.ofFloat(binding.cardviewKanao, "translationX", 0f, -350f)
            ...
            animatorSet.addListener(object : AnimatorListenerAdapter() {
                override fun onAnimationEnd(animation: Animator) {
                    ...
                    activity?.let {
                        displayTextWordByWord(100,binding.textViewNameKanao, it.getString(R.string.name_of_kanao_txt)) {
                            Handler(Looper.getMainLooper()).postDelayed({
                                displayTextWordByWord(30,binding.textViewStoryLong, it.getString(R.string.kanao_story_txt))
                            }, 250)
                        }
