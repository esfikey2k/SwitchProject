...
import com.example.switchproject.databinding.FragmentKindnessBinding
...
class KindnessFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        try {
            ...
            val animator = ObjectAnimator.ofFloat(binding.cardviewTanjiro, "translationX", 0f, -350f)
            ...
            animatorSet.addListener(object : AnimatorListenerAdapter() {
                override fun onAnimationEnd(animation: Animator) {
                    ...
                    activity?.let {
                        displayTextWordByWord(100,binding.textViewNameTanjiro, it.getString(R.string.name_of_kamado_txt)) {
                            Handler(Looper.getMainLooper()).postDelayed({
                                displayTextWordByWord(30,binding.textViewStoryLong, it.getString(R.string.kamado_story_txt))
                            }, 250)
                        }
