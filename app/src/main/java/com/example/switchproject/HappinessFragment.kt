...
import com.example.switchproject.databinding.FragmentHappinessBinding
...
class HappinessFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        try {
            ...
            val animator = ObjectAnimator.ofFloat(binding.cardviewNezuko, "translationX", 0f, -350f)
            ...
            animatorSet.addListener(object : AnimatorListenerAdapter() {
                override fun onAnimationEnd(animation: Animator) {
                    ...
                    activity?.let {
                        displayTextWordByWord(100,binding.textViewNameNezuko, it.getString(R.string.name_of_nezuko_txt)) {
                            Handler(Looper.getMainLooper()).postDelayed({
                                displayTextWordByWord(30,binding.textViewStoryLong, it.getString(R.string.nezuko_story_txt))
                            }, 250)
                        }
                    }
                }
